...
public class InsertWindow extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Person person = new Person(id, name, lastname1, lastname2, birthdate, country, parentId);
            XMLPersonFile xmlpf = new XMLPersonFile("./data/my_family_tree.xml");
            xmlpf.insertPerson(person);
